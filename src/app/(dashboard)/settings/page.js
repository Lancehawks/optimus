...
export default function SettingsPage() {
  ...
  return (
    <div className="optimus-page optimus-page-settings p-6 lg:p-8 max-w-4xl mx-auto">
      <PageHeader
        title="Settings"
        eyebrow="Preferences"
        description="Personalize how Optimus looks, feels, and protects your account."
        icon={
